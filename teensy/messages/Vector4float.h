#ifndef _ROS_astrocent_Vector4float_h
#define _ROS_astrocent_Vector4float_h
...
namespace astrocent
{
  ...
  class Vector4float : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "astrocent/Vector4float"; };
